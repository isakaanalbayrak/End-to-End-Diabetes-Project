...
def grab_col_names(dataframe, cat_th=10, car_th=20):
    ...
    ------
        ...
        The total of the three lists equals the total number of variables: cat_cols + num_cols + cat_but_car = variable count
    """
...
df = pd.read_csv("C:/Users/Isa Kaan Albayrak/Desktop/Eğitimler/Miuul/MachineLearning/machine_learning/datasets/diabetes.csv")
...
# Keeping the updated variable types
cat_cols, num_cols, cat_but_car = grab_col_names(df, cat_th=5, car_th=20)
cat_cols = [col for col in cat_cols if "OUTCOME" not in col]
...
df = pd.read_csv("../../Eğitimler/Miuul/MachineLearning/machine_learning/datasets/diabetes.csv")
